...
void		init_tab_signal_exec(struct sigaction tab_signal[NB_SIGNALS])
{
	...
	tab_signal[SIGABRT] = set_sigaction_struct(sigabrt_exec, SA_RESTART, sigset);
	tab_signal[SIGFPE] = set_sigaction_struct(sigfpe_exec, SA_RESTART, sigset);
	tab_signal[SIGBUS] = set_sigaction_struct(sigbus_exec, SA_RESTART, sigset);
	tab_signal[SIGSEGV] = set_sigaction_struct(sigsegv_exec, SA_RESTART, sigset);
	tab_signal[SIGSYS] = set_sigaction_struct(sigsys_exec, SA_RESTART, sigset);
	tab_signal[SIGQUIT] = set_sigaction_struct(sigquit_exec, SA_RESTART, sigset);
	tab_signal[SIGTERM] = set_sigaction_struct(sigterm_exec, SA_RESTART, sigset);
